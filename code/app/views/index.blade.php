...
@section('content')
	...
	<div class="row login-container animated fadeInUp">
		<div class="col-md-4 col-md-offset-4 p-t-30 p-l-40 p-r-40 p-b-20 xs-p-t-10 xs-p-l-10 xs-p-b-10 tiles white">
			...
			{{ Form::open(array('url' => '/', 'id' => 'frm_login', 'method' => 'POST')) }}
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="controls">
						<div class="input-with-icon right">
							<i class=""></i> <input type="text" name="username" id="username" class="form-control">
			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="controls">
						<div class="input-with-icon  right">
							<i class=""></i> <input type="password" name="password" id="password" class="form-control">
