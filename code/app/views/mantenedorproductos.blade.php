		...
		<div class="panel panel-danger" style="margin-bottom: 6px;">
			...
			<div class="panel-body">
				...
				<div class="form-group" style="width:250px;">
					<label for="codean">COD. EAN</label>
					<input type="text" class="form-control" placeholder="COD. EAN" name="nombres" style="width:250px;">
				</div>
				<div class="form-group" style="width:500px;">
					<label for="descripcion">DESCRIPCION</label>
					<input type="text" class="form-control" placeholder="Descripcion" name="descripcion" style="width:500px;">
				</div>
			</div>
			{{ Form::close() }}
		</div>
		...
		<div class="panel panel-danger" style="margin-bottom: 6px;">
			<div class="panel-body">
				...
				<div class="form-group" style="width:180px;">
					...
					<input type="text" class="form-control" placeholder="Precio" name="precio" style="width:180px;">
				</div>
				<div class="form-group" style="width:400px;">
					<label for="ciudad">Proveedor</label>
					<input type="text" class="form-control" placeholder="Proveedor" name="proveedor" style="width:400px;">
				</div>
				<div class="form-group" style="width:300px;">
					<label for="marca">Marca</label>
					<input type="text" class="form-control" placeholder="marca" name="marca" style="width:300px;">
				</div>
			</div>
			{{ Form::close() }}
		</div>
