...
@section('breadcrumb')
	@parent
	<li><a href="#" class="active">Medida</a></li>
@endsection

@section('page-title')
	<i class="icon-custom-left"></i>
	<h3>Mantenedor <span class="semi-bold">Medida</span></h3>
@endsection
...
@section('content')
	...
	<div class="grid simple vertical red">
		<div class="grid-title no-border">
			<h4>Crear/Modificar <span class="semi-bold">Medidas</span></h4>
				...
				<div class="row form-row">
					<div class="col-md-12">
						...
						<div class="row form-row">
							<div class="col-md-12">
								<div class="input-group">
									<input name="form3FirstName" id="form3FirstName" type="text" class="form-control" placeholder="Nombre Medida">
						...
						<div class="row form-row">
							<div class="col-md-4">
								<div class="input-group">
									<input name="form3City" id="form3City" type="text" class="form-control" placeholder="Estado">
									<span class="input-group-addon primary">
										<span class="arrow"></span>
										<i class="fa fa-ellipsis-h"></i>
									</span>
							...
							<div class="col-md-8">
								<div class="input-group">
									<input name="form3State" id="form3State" type="text" class="form-control" placeholder="Descripción">
									<span class="input-group-addon primary">
										<span class="arrow"></span>
										<i class="fa fa-ellipsis-h"></i>
									</span>
