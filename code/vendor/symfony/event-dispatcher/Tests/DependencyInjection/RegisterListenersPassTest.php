...
class RegisterListenersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEventSubscriberWithoutInterface()
    {
        ...
        $definition->expects($this->atLeastOnce())->method('isPublic')->will($this->returnValue(true));
    ...
    public function testValidEventSubscriber()
    {
        ...
        $definition = $this->getMock('Symfony\Component\DependencyInjection\Definition');
        $definition->expects($this->atLeastOnce())->method('isPublic')->will($this->returnValue(true));
        $definition->expects($this->atLeastOnce())->method('getClass')->will($this->returnValue('Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService'));

        $builder = $this->getMock('Symfony\Component\DependencyInjection\ContainerBuilder', array('hasDefinition', 'findTaggedServiceIds', 'getDefinition', 'findDefinition'));
        $builder->expects($this->any())->method('hasDefinition')->will($this->returnValue(true));
    ...
    public function testEventSubscriberResolvableClassName()
    {
        ...
        $expected_calls = array(array('addSubscriberService',
                                      array('foo',
